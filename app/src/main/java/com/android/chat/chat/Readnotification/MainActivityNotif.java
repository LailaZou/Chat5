...
import com.android.chat.chat.MainActivity;
import com.android.chat.chat.R;

import java.util.Timer;
import java.util.TimerTask;

public class MainActivityNotif extends PreferenceActivity {
    @Override
    ...
    public void onBackPressed() {
        Intent intent = new Intent(MainActivityNotif.this, MainActivity.class);
    ...
    public static class MainFragment extends PreferenceFragment implements OnPreferenceClickListener, OnSharedPreferenceChangeListener {
        ...
        //, pDeviceState ,pQuietStart, pQuietEnd, pTest, pNotifyLog, pSupport;
