...
class Database extends SQLiteOpenHelper {
    ...
    static synchronized List<App> getApps() {
        ...
        while (cursor.moveToNext()) {
            Log.d("Apppppppppppppppppp", "app : "+cursor.getString(cursor.getColumnIndex(COLUMN_LABEL)));

           if( cursor.getString(cursor.getColumnIndex(COLUMN_PACKAGE)).equals("com.android.chat.chat")){
    ...
    static synchronized void setApps(List<App> apps) {
        ...
        for (App app : list) {
            Log.d("Apppppppppppppppppp2", "app : "+app.getLabel());


            if(app.getPackage().equals("com.android.chat.chat")){
    ...
    static synchronized void addOrUpdateApp(App app) {
        ...
        Log.d("Apppppppppppppppppp3 ", "app : "+app.getLabel());
